...
using ConsoleHostAppML.Model;

namespace ConsoleHostAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\cvuhu\source\repos\CurrentVIP\ConsoleHostApp\ConsoleHostApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\cvuhu\AppData\Local\Temp\MLVSTools\ConsoleHostAppML\ConsoleHostAppML.Model\MLModel.zip";
